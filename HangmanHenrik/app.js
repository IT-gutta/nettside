...
var ordListe = ["Gestikulere", "Diame tralt", "Lapidarisk", "Kontaminering", "Digresjon", "Provisorisk", "Persepsjon", "Paradoks", "Implisitt", "Omkalfatrere"]
...
knapp.addEventListener("click", function() {
  ...
  for (var i = 0; i < utvalgtOrd.length; i++) {
    if (utvalgtOrd[i].toLowerCase() == gjettaBokstav || utvalgtOrd[i].toUpperCase() == gjettaBokstav) {
      ...
      if (i == utvalgtOrd.length - 1 && verdi2 == 0) {
...
function spillSlutt() {
  setTimeout(function(){
    ...
    document.getElementById("splillSluttMelding").innerHTML += "<br>" + "Du tapte. Ordet var " + "<b>" + "'" + utvalgtOrd + "'" + "</b>"}, 500)
